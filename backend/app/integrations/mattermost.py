...
class MattermostClient:
        ...
        return {
            ...
            "attachments": [{
                ...
                "fields": [
                    ...
                    {"title": "Status", "value": "🔴 **LATE**", "short": True},
                    {"title": "Expected Every", "value": f"{int(check.period_seconds or 0) // 3600}h {int(check.period_seconds or 0) % 3600 // 60}m", "short": True},
                    {"title": "Grace Period", "value": f"{int(check.grace_seconds or 0) // 60}m", "short": True},
                    {"title": "Last Ping", "value": check.last_ping_at or "Never", "short": False},
                ],
        ...
        return {
            ...
            "attachments": [{
                ...
                "fields": [
                    ...
                    {"title": "Last Ping", "value": check.last_ping_at or "Just now", "short": True},
                    {"title": "Next Expected", "value": f"Within {check.period_seconds // 3600}h {(check.period_seconds % 3600) // 60}m", "short": True},
                ],
                "footer": "Pulsechecks Alert System",
                "ts": get_current_time_seconds(),
            }]
    ...
    async def _send_message(self, message: Dict[str, Any]) -> bool:
        ...
        try:
            assert_webhook_url_safe(self.webhook_url)
...
def _format_escalated_alert_method(self, check, team_name: str):
    ...
    return {
        ...
        "attachments": [{
            ...
            "fields": [
                {"title": "Team", "value": team_name, "short": True},
                {"title": "Status", "value": "🚨 **ESCALATED**", "short": True},
                {"title": "Escalated After", "value": f"{check.escalation_minutes} minutes", "short": True},
                {"title": "Expected Every", "value": f"{check.period_seconds // 3600}h {(check.period_seconds % 3600) // 60}m", "short": True},
                {"title": "Last Ping", "value": check.last_ping_at or "Never", "short": False},
            ],
